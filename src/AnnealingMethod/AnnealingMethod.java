...
//        rProvidedValueLabel = new JLabel("r - Радиус(предоставленное значение):");
        ...
        x1ProvidedValueLabel = new JLabel("x - Начало профиля, м");
...
//        x2ProvidedValueLabel = new JLabel("x2 - Конец профиля, м");
        ...
        z1ProvidedValueLabel = new JLabel("h1 - Глубина, м");

        z2ProvidedValue = new JTextField(16);
        z2ProvidedValue.setEditable(true);
        z2ProvidedValueLabel = new JLabel("h2 - Глубина, м");
...
//        rIntervalPercentLabel = new JLabel("Процент для определения Интервала выборки(+-), для r(Радиус):");
        ...
        x1IntervalPercentLabel = new JLabel("Погрешность изменения x:");
...
//        rIntervalStepLabel = new JLabel("Шаг в интервале, для r(Радиус):");
        ...
        x1IntervalStepLabel = new JLabel("Шаг в интервале, для x:");
...
//        hIntervalStepLabel = new JLabel("Шаг в интервале, для h(Глубина):");
        ...
        author = new JLabel("<html>Оптимизация Методом Отжига. Геометрическое тело: Уступ;<br /> Автор: Назирова Асем;<br /><br />Введите данные для начала процесса Оптимизации:<br /><html>");
